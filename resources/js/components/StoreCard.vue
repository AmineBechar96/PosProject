<template>
    ...
    <div class="grid my-4  gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-2 "></div>
    <div class="flex flex-col">
        <div class="bg-white shadow-md  rounded-3xl p-4 w-1/2 mx-auto">
            <a href="giiglz.xil">
                    ...
                    <div class="flex-auto ml-3 justify-evenly py-2">
                        ...
                        <div class="flex space-x-3 text-sm font-medium">
                            <div class="flex-auto flex space-x-3">
                                <button
                                    class="mb-2 md:mb-0 bg-red-200 px-5 py-2 shadow-sm tracking-wider border text-gray-600 rounded-full hover:bg-gray-100 inline-flex items-center space-x-2 ">
