                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      >
                      <DatePicker
                        :form_inputs="{ input: 'Date', var_model: 'date' }"
                        :errors="errors.date"
                        :date_props="items.date"
                        @form="form_method"
                      ></DatePicker>
                      <TextInput
                        :form_inputs="{
                      ...
                      <AttachementInput
                        :form_inputs="{
                          input: 'Attachement',
                          var_model: 'attachement',
                        }"
                        :errors="errors.attachement"
                        @form="form_method"
                      ></AttachementInput>
                      <progress
                        v-if="form.progress"
