<template>
    <div class="bg-gray-100 w-screen">
        <TheNavbar />
        <BreadcumberComponent class="mt-6 ml-20"></BreadcumberComponent>
        <div
            ...
            <div class="flex items-center justify-between pb-2 mb-2">
                <DropdownComponent :filters="filters" routes="categories"></DropdownComponent>
                <SearchInput :filters="filters" routes="categories"></SearchInput>
            </div>
            <div class="flex items-center">
                <TableComponent :data="categories"></TableComponent>
            </div>
