            ...
            >
              <div class="flex items-center justify-between">
                ...
                <div class="flex">
                  ...
                  <button
                    class="btn next-btn h-7 w-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 disabled:pointer-events-none disabled:select-none disabled:opacity-60 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" @click="slideNext"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-5 w-5"
              ...
              <swiper-container class="mt-5" slides-per-view="6" speed="500" loop="true" css-mode="true" >
                <swiper-slide
          ...
          <div class="hidden sm:col-span-6 sm:block lg:col-span-4">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-1">
                <p>
                  <span
                    class="text-base font-medium text-slate-700 dark:text-navy-100 mr-2"
                    >Draft</span
                  >
                  <span>#001</span>
                </p>
