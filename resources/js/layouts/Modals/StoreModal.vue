                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <TextInput
                        type="number"
                        :form_inputs="{ input: 'Cash In Hand',var_model:'cash' }"
                        @form="form_method"
                      ></TextInput>
                      <div
                        class="flex-grow border-t my-5 border-gray-200"
                      ></div>
                      <TextInput
                        type="number"
                        :form_inputs="{ input: waiter.name ,var_model:waiter.id }"
                        v-for="waiter in data.waiters"
                        :key="waiter.id"
                        @form="form_method"
                      ></TextInput>
                    </div>
...
function form_method({ form_inputs, value }) {
  if (form_inputs == "cash")
    form["cashinhand"] = value;
  else
  form["waiters"][form_inputs] = value;
  form["store_id"] = props.data.id;
}
</script>