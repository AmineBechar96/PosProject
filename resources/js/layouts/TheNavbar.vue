...
const navigation = [
  ...
  { name: 'SALES', href: '/sales', current: true, icon: "fa-solid fa-receipt" ,subMenu:"monoMenu"},
  { name: 'PURCHASE', href: '/purchases', current: false, icon: "fa-solid fa-file-invoice" ,subMenu:"monoMenu"},
